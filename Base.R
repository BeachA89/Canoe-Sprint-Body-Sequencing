...
BoatdfAl <- data.frame(fread(choose.files(default = "C:/Users/aaron.beach/CaptureU/a", caption = "Select Boat File")))
PelvisdfAl <- data.frame(fread(choose.files(default = "C:/Users/aaron.beach/CaptureU/a", caption = "Select Pelvis File")))
ThoraxdfAl <- data.frame(fread(choose.files(default = "C:/Users/aaron.beach/CaptureU/a", caption = "Select Thorax File")))
MinimaxdfAl <- data.frame(fread(choose.files(default = "C:/Users/aaron.beach/CaptureU/a", caption = "Select Minimax File")))
