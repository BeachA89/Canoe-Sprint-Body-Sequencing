...
FootdfAl <- data.frame(fread(choose.files(default = "C:/Users/aaron.beach/CaptureU/Alex DTE 14092020/a", caption = "Select Foot File")))
PelvisdfAl <- data.frame(fread(choose.files(default = "C:/Users/aaron.beach/CaptureU/Alex DTE 14092020/a", caption = "Select Pelvis File")))
ThoraxdfAl <- data.frame(fread(choose.files(default = "C:/Users/aaron.beach/CaptureU/Alex DTE 14092020/a", caption = "Select Thorax File")))
...
# residual_analysis(FootdfAl$ResAcc, cutoff_range = c(0, 800), sample_freq = 1600,
...
ev <-  ggplot() + geom_line(aes(x=FootdfAl$V1, y=(FootdfAl$ResAccfilt))) +geom_point(aes(x=Event[,2], y=Event[,1]))#+ geom_line(aes(x=PelvisdfAl$V1, y=(PelvisdfAl$highg_ax_m.s.s), colour = "red"))
ggplotly(ev)
